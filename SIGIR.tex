...
%where $\mathcal{\Epsilon}: \mathcal{V} \leftarrow \mathcal{R}^d$ is the embedding function that projects $\mathcal{V}$ the vocabulary set to the embedding space with dimension $d$. 
