...
A good salesperson must also be \textit{knowledgable}. %ensure they highlight each product?s strongest features. Deep product knowledge is honestly one of the few things that separates the top 1% of reps from the rest
Therefore a \texit{knowledge aware} system. 
