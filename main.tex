...
Explainable recommendation belongs to the broader research topic of explainable AI, which has 

%explainable models:.
Explainable latent factor models, explainable neural models, explainable sequential models~\cite{Chen2018Sequential}
memory-augmented neural network (MANN) integrated with the insights of collaborative filtering for recommendation. By leveraging the external memory matrix in MANN, we store and update users» historical records explicitly, 
...
In this sense, ~\cite{Peake2018Explanation} can be considered as a pointwise
...
%explanation types
new types of explanations. sentence explanations 
